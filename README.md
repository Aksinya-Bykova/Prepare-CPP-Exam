...
3. Что такое правило 3? Почему оно такое?
4. Что такое правило 5? Почему оно такое?
5. Что такое правило 0? Почему оно такое?
6. Определение полиморфизма
7. Что такое проблема ромба?
8. Что такое виртуальное наследование? Как работает таблица виртуальных функций?
9. Виртуальные функции значат, что есть динамический полиморфизм?
10. Зачем нужно ключевое слово override?
11. В какой памяти обычно лежит vtable?
